...
export default function Component1() {
    ...
    const newstopic_predefined=(event)=>{
      ...
      fetch(`https://newsapi.org/v2/everything?q=${event.target.innerText}&apiKey=de713b26887d4c68a61209262645aa51`)
      .then((res)=>res.json())
      .then(json=>{setPost(json)})
  ...
  return (
    <div id="component1_main_div">
      ...
      <input type="search" id="searchbox_id" onChange={set_topic_value} value={topic1} autoFocus/>
       <button  id="find_btn_id" onClick={getData}>Find</button>
